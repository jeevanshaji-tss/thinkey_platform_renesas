...
/**
 * \brief T5T Tag specific default timeout
 */
#define PTX_T5T_DEFAULT_TIMEOUT_MS   (uint32_t)200
/**
 * \brief T5T Tag specific default supported version
 */
#define PTX_T5T_SUPPORTED_VERSION    (uint8_t)0x11
 ...
 *
 * \param[in]   t5tOpComp           Pointer to an existing instance of the T5T-OP component.
